...
class AttU_Net(nn.Module):
    ...
    """
    def __init__(self, img_ch=3, output_ch=1,pretrained=False):
...
def get_attunet( num_classes=1, num_channels=3,pretrained=False):

    model = AttU_Net(num_classes=1, num_channels=3,pretrained=False)
